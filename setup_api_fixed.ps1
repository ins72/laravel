...
# Step 6: Create API documentation directory
Write-Host "`nStep 6: Creating API documentation structure..." -ForegroundColor Yellow
try {
    $docsPath = "docs\api"
...
# Step 7: Install API documentation packages
Write-Host "`nStep 7: Installing API documentation packages..." -ForegroundColor Yellow
try {
...
# Step 8: Publish Scribe configuration
Write-Host "`nStep 8: Publishing Scribe configuration..." -ForegroundColor Yellow
try {
...
# Step 9: Create API test files
Write-Host "`nStep 9: Creating API test files..." -ForegroundColor Yellow
try {
...
# Step 10: Update .env for API configuration
Write-Host "`nStep 10: Updating .env for API configuration..." -ForegroundColor Yellow
try {
    if (Test-Path ".env") {
...
# Step 11: Clear and cache configurations
Write-Host "`nStep 11: Clearing and caching configurations..." -ForegroundColor Yellow
try {
...
Write-Host "`nStep 12: Starting servers..." -ForegroundColor Yellow
try {
...
Write-Host "`nCRUD Endpoints:" -ForegroundColor Cyan
